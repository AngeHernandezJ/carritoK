...
if (productoEncontrado) {
    ...
    //const producto = localStorage.getItem("productosEnCarrito");
    /*fetch("./productos.json")
    .then(data => {
        let productos = data;
        //let productoId = 2;
        let productoEncontrado = productos.find(producto => producto.id === productosEnCarrito);
    ...
    div.innerHTML = `
            ...
            `;
/*<button class="carrito-producto-eliminar" id="${producto.eliminar}"><i class="bi bi-trash-fill"></i></button> */
